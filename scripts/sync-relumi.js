...
const MANUAL_POKEDEX_OVERRIDES = {
	...
	// The base Minior entry gains the new otherFormes; cosmeticFormes are preserved from gen9.
	minior: {
		inherit: true,
		cosmeticFormes: ["Minior-Orange", "Minior-Yellow", "Minior-Green", "Minior-Blue", "Minior-Indigo", "Minior-Violet"],
		otherFormes: [
			"Minior-Meteor",
			"Minior-Meteor-Orange", "Minior-Meteor-Yellow", "Minior-Meteor-Green",
			"Minior-Meteor-Blue", "Minior-Meteor-Indigo", "Minior-Meteor-Violet",
		],
	},
	// Each colored meteor forme is battleOnly → its matching core colour.
	miniormeteororange: {
		name: "Minior-Meteor-Orange", baseSpecies: "Minior", forme: "Meteor-Orange",
		types: ["Rock", "Flying"], gender: "N",
		baseStats: { hp: 60, atk: 60, def: 100, spa: 60, spd: 100, spe: 60 },
		abilities: { 0: "Shields Down" }, heightm: 0.3, weightkg: 40,
		color: "Brown", eggGroups: ["Mineral"],
		requiredAbility: "Shields Down", battleOnly: "Minior-Orange",
	},
	miniormeteoryellow: {
		name: "Minior-Meteor-Yellow", baseSpecies: "Minior", forme: "Meteor-Yellow",
		types: ["Rock", "Flying"], gender: "N",
		baseStats: { hp: 60, atk: 60, def: 100, spa: 60, spd: 100, spe: 60 },
		abilities: { 0: "Shields Down" }, heightm: 0.3, weightkg: 40,
		color: "Brown", eggGroups: ["Mineral"],
		requiredAbility: "Shields Down", battleOnly: "Minior-Yellow",
	},
	miniormeteorgreen: {
		name: "Minior-Meteor-Green", baseSpecies: "Minior", forme: "Meteor-Green",
		types: ["Rock", "Flying"], gender: "N",
		baseStats: { hp: 60, atk: 60, def: 100, spa: 60, spd: 100, spe: 60 },
		abilities: { 0: "Shields Down" }, heightm: 0.3, weightkg: 40,
		color: "Brown", eggGroups: ["Mineral"],
		requiredAbility: "Shields Down", battleOnly: "Minior-Green",
	},
	miniormeteorblue: {
		name: "Minior-Meteor-Blue", baseSpecies: "Minior", forme: "Meteor-Blue",
		types: ["Rock", "Flying"], gender: "N",
		baseStats: { hp: 60, atk: 60, def: 100, spa: 60, spd: 100, spe: 60 },
		abilities: { 0: "Shields Down" }, heightm: 0.3, weightkg: 40,
		color: "Brown", eggGroups: ["Mineral"],
		requiredAbility: "Shields Down", battleOnly: "Minior-Blue",
	},
	miniormeteorindigo: {
		name: "Minior-Meteor-Indigo", baseSpecies: "Minior", forme: "Meteor-Indigo",
		types: ["Rock", "Flying"], gender: "N",
		baseStats: { hp: 60, atk: 60, def: 100, spa: 60, spd: 100, spe: 60 },
		abilities: { 0: "Shields Down" }, heightm: 0.3, weightkg: 40,
		color: "Brown", eggGroups: ["Mineral"],
		requiredAbility: "Shields Down", battleOnly: "Minior-Indigo",
	},
	miniormeteorviolet: {
		name: "Minior-Meteor-Violet", baseSpecies: "Minior", forme: "Meteor-Violet",
		types: ["Rock", "Flying"], gender: "N",
		baseStats: { hp: 60, atk: 60, def: 100, spa: 60, spd: 100, spe: 60 },
		abilities: { 0: "Shields Down" }, heightm: 0.3, weightkg: 40,
		color: "Brown", eggGroups: ["Mineral"],
		requiredAbility: "Shields Down", battleOnly: "Minior-Violet",
	},
};
